...
export default function TaskCard({ task }: TaskCardProps) {
  ...
  return (
    <TooltipProvider delayDuration={300}>
      <div
        className="flex items-center gap-[15px] bg-background rounded-lg px-[18px] py-[10px] border border-transparent cursor-pointer hover:shadow-[0_1px_6px_rgba(0,0,0,0.08)] hover:border-primary/20 transition-colors transition-shadow duration-200 ease-out"
        onClick={handleClick}
        role="button"
        tabIndex={0}
