...
export default function TaskCard({ task }: TaskCardProps) {
  ...
  return (
    <TooltipProvider delayDuration={300}>
      <div
        className="flex items-center gap-[15px] bg-background rounded-lg px-[18px] py-[10px] cursor-pointer hover:shadow-[0_-2px_12px_rgba(0,0,0,0.08),0_6px_20px_rgba(0,0,0,0.12)] hover:-translate-y-[3px] hover:bg-primary/[0.02] transition-all duration-200"
        onClick={handleClick}
        role="button"
        tabIndex={0}
