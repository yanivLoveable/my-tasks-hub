  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        info: "hsl(var(--info))",
        "task-action": "hsl(var(--task-action))",
        "task-action-hover": "hsl(var(--task-action-hover))",
      ...
      animation: {
        ...
        "task-enter": "task-enter 0.45s cubic-bezier(0.4, 0, 0.2, 1) forwards",
        "task-exit": "task-exit 0.35s cubic-bezier(0.4, 0, 0.2, 1) forwards",
      },
    },
  },
